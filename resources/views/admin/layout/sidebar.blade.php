<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseSubcategory" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Sub Category</h6>
            <a class="collapse-item" href="{{route('subcategory.create')}}">Create</a>
            <a class="collapse-item" href="{{route('subcategory.index')}}">Index</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
